...
df_portfolios = pd.read_parquet("portefeuilles_q3_eodhd.parquet")  # <== adapter à q=3, q=30, etc.
with open("prices_by_year_eodhd.pkl", "rb") as f:
    prices_by_year = pickle.load(f)

df_fits = pd.read_csv("resultats_portefeuilles.csv")
...
df_tests.to_csv("tests_statistiques_complets.csv", index=False)
print("✅ Résultats exportés dans tests_statistiques_complets.csv")
